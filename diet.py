...
def BMR():
    ...
    elif act == 'Lightly active - 1 to 3 days a week)':
        cal = cal*1.375

    elif act == 'Moderately active - 3 to 5 days a week)':
        cal = cal*1.55

    elif act == 'Very active - 6 to 7 days a week)':
        cal = cal*1.725

    elif act == 'Super active - twice aday':
        cal = cal*1.9
...
Lb.insert(2, 'Lightly active - 1 to 3 days aweek')
Lb.insert(3, 'Moderately active - 3 to 5 days a week')
Lb.insert(4, 'Very active - 6 to 7 days a week)')
Lb.insert(5, 'Super active - twice a day)')
